...
<div class="main-panel">
  <div class="content-wrapper">
    <div class="page-header">
      <div class="page-header">
        <h1><i class="mdi mdi-database icon-lg"></i>  ทะเบียนอุปกรณ์  </h1>
      </div>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?=$_POST['url_back'];?>"> ทะเบียนอุปกรณ์ </a></li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label" align="right">รหัสอุปกรณ์ <span style="color:red;" >*</span> : </label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control ClearData checkinput" id="equ_number" name="equ_number" value="<?=$rec_main['equ_number'];?>" checkinput-text="รหัสอุปกรณ์">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
					 <input type="text" class="form-control ClearData" id="equ_gen" name="equ_gen" value="<?=$rec_main['equ_gen'];?>">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control ClearData checkinput" id="equ_year" name="equ_year" value="<?=$rec_main['equ_year'];?>" checkinput-text="ปีที่ซื้อ">
                  </div>
                </div>
              </div>
            </div>
			<div class="row">
				<div class="col-md-6">
					<div class="row">
					  <div class="col-md-12">
						<div class="form-group row">
						  <label class="col-sm-3 col-form-label" align="right">series no ตามผู้ขาย : </label>
						  <div class="col-sm-9">
							 <input type="text" class="form-control ClearData" id="series_no" name="series_no" value="<?=$rec_main['series_no'];?>">
						  </div>
						</div>
					  </div>
					</div>
