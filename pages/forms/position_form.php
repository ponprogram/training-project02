<?php
  ...
  $sql_main = "SELECT * FROM m_position WHERE pos_id = '".$_POST['pos_id']."'";
  ...
  <div class="content-wrapper">
    <div class="page-header">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?=$_POST['url_back'];?>">ตั้งค่าตำแหน่ง</a></li>
        ...
        <form id="frm-input" action="" method="post">
			...
			<input type="hidden" id="pos_id" name="pos_id" value="<?=$_POST['pos_id'];?>">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label class="col-sm-3 col-form-label" align="right">ชื่อตำแหน่ง <span style="color:red;" >*</span> : </label>
										<div class="col-sm-7">
											<input type="text" class="form-control ClearData checkinput" id="pos_name" name="pos_name" value="<?=$rec_main['pos_name'];?>" checkinput-text="ชื่อตำแหน่ง">
										</div>
									</div>
								</div>
							</div>
    ...
    if(sum==ifsum){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $("#frm-input").attr("action","process/position_proc.php").submit();
            }
        });
    }
  });
