  ...
  <div class="content-wrapper">
    <div class="page-header">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?=$_POST['url_back'];?>">ตั้งค่าระดับผู้ใช้งาน</a></li>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label class="col-sm-3 col-form-label" align="right">ชื่อระดับผู้ใช้งาน <span style="color:red;" >*</span> : </label>
										<div class="col-sm-7">
											<input type="text" class="form-control ClearData checkinput" id="lavel_name" name="lavel_name" value="<?=$rec_main['lavel_name'];?>" checkinput-text="ชื่อระดับผู้ใช้งาน">
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-2">
											<div class="form-check">
												...
												<input type="radio" class="form-check-input" name="ACTVE_STATUS" id="ACTVE_STATUS1" value="1" <?=($rec_main['active_status']==1)?'checked':'checked';?>> ใช้งาน </label>
											</div>
										</div>
										<div class="col-sm-2">
											<div class="form-check">
