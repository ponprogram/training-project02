<?php
  ...
  $sql_main = "SELECT * FROM perfix WHERE perfix_id = '".$_POST['perfix_id']."'";
...
<div class="main-panel">
  <div class="content-wrapper">
    <div class="page-header">
      <div class="page-header">
        <h1><i class="mdi mdi-settings icon-lg"></i> ตั้งค่าคำนำหน้า </h1>
      </div>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?=$_POST['url_back'];?>">ตั้งค่าคำนำหน้า</a></li>
        ...
        <form id="frm-input" action="" method="post">
			...
			<input type="hidden" id="perfix_id" name="perfix_id" value="<?=$_POST['perfix_id'];?>">
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label class="col-sm-3 col-form-label" align="right">คำนำหน้าภาษาไทย <span style="color:red;" >*</span> : </label>
										<div class="col-sm-7">
											<input type="text" class="form-control ClearData checkinput" id="perfix_name_th" name="perfix_name_th" value="<?=$rec_main['perfix_name_th'];?>" checkinput-text="คำนำหน้าภาษาไทย">
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label class="col-sm-3 col-form-label" align="right">คำนำหน้าภาษาอังกฤษ : </label>
										<div class="col-sm-7">
											<input type="text" class="form-control ClearData" id="perfix_name_en" name="perfix_name_en" value="<?=$rec_main['perfix_name_en'];?>">
										</div>
									</div>
								</div>
							</div>
    ...
    if(sum==ifsum){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $("#frm-input").attr("action","process/perfix_proc.php").submit();
            }
        });
    }
  });
