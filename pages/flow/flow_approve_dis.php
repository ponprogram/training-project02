			...
			<div class="card">
				<div class="card-body">
					<form id="frm-search" action="" method="post">
					  ...
					  <input type="hidden" id="url_back" name="url_back" value="flow_approve_dis.php<?=$Link;?>">
					  <div class="row">
					...
					<ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="<?=$part;?>pages/flow/flow_approve_dis.php<?=$Link;?>">รอดำเนินการ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?=$part;?>pages/flow/flow_approve_dis2.php<?=$Link;?>">ระหว่างดำเนินการ</a>
                        </li>
                        <li class="nav-item">
...
function stretchData(){
    $("#frm-search").attr("action","flow_approve_dis.php<?=$Link;?>").submit();
}
